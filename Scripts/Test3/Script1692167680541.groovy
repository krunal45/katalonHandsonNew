...
WebUI.setText(findTestObject('Page_OrangeHRM/input_Password_password'), 'admin123', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_OrangeHRM/userNameTextBox'), 'Admin')
